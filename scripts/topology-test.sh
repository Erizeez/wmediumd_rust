...
# nohup gnome-terminal --disable-factory -- sudo ip netns exec wmediumd-net-5 bash &
# nohup gnome-terminal --disable-factory -- sudo ip netns exec wmediumd-net-7 bash &
